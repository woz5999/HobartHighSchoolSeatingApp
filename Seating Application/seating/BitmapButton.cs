...
#region Paint Methods
		...
		private void paint_Text(PaintEventArgs e)
		{
			...
			if(btnState == BtnState.Inactive)
			{
				e.Graphics.DrawString(this.Text,this.Font, new SolidBrush(System.Drawing.Color.White),pt.X+1,pt.Y+1,sf); 
				e.Graphics.DrawString(this.Text,this.Font, new SolidBrush(System.Drawing.Color.FromArgb(50,50,50)),pt.X,pt.Y,sf);
			}
			//
			...
			else
			{
				...
				if(TextDropShadow)
				{
					...
					e.Graphics.DrawString(this.Text,this.Font, TransparentBrush0,pt.X,pt.Y+1,sf); 
					e.Graphics.DrawString(this.Text,this.Font, TransparentBrush0,pt.X+1,pt.Y,sf); 

					e.Graphics.DrawString(this.Text,this.Font, TransparentBrush1,pt.X+1,pt.Y+1,sf); 
					e.Graphics.DrawString(this.Text,this.Font, TransparentBrush1,pt.X,pt.Y+2,sf); 
					e.Graphics.DrawString(this.Text,this.Font, TransparentBrush1,pt.X+2,pt.Y,sf);
				...
				// paint text
				//
				e.Graphics.DrawString(this.Text,this.Font, new SolidBrush(this.ForeColor),pt.X,pt.Y,sf); 
			}  
		}
		/// <summary>
...
#region Helper Methods
		...
		private System.Drawing.SizeF txt_Size(Graphics g,string strText,Font font)
		{
			StringFormat sf = new StringFormat();
			sf.HotkeyPrefix = System.Drawing.Text.HotkeyPrefix.Show;
			System.Drawing.SizeF size = g.MeasureString(strText,font,9999,sf);
			return (size);		   
		}
		/// <summary>
